...
export const DEVELOPMENT_TECHNOLOGIES = [
  { name: "React", technology_type: "FRONTEND" },
  { name: "Vue.js", technology_type: "FRONTEND" },
  { name: "Angular", technology_type: "FRONTEND" },
  { name: "Node.js", technology_type: "BACKEND" },
  { name: "Express", technology_type: "BACKEND" },
  { name: "Django", technology_type: "BACKEND" },
  { name: "Flask", technology_type: "BACKEND" },
  { name: "Ruby on Rails", technology_type: "BACKEND" },
  { name: "Spring Boot", technology_type: "BACKEND" },
  { name: "Laravel", technology_type: "BACKEND" },
  { name: "GraphQL", technology_type: "BACKEND" },
  { name: "TypeScript", technology_type: "LANGUAGES" },
  { name: "JavaScript", technology_type: "LANGUAGES" },
  { name: "Python", technology_type: "LANGUAGES" },
  { name: "Java", technology_type: "LANGUAGES" },
  { name: "C#", technology_type: "LANGUAGES" },
  { name: "Docker", technology_type: "INFRA" },
  { name: "Kubernetes", technology_type: "INFRA" },
  { name: "Redis", technology_type: "DB" },
  { name: "PostgreSQL", technology_type: "DB" },
  { name: "MongoDB", technology_type: "DB" },
  { name: "AWS", technology_type: "INFRA" },
  { name: "Azure", technology_type: "INFRA" },
  { name: "GCP", technology_type: "INFRA" },
  { name: "Webpack", technology_type: "TOOLS" },
  { name: "Babel", technology_type: "TOOLS" },
  { name: "Tailwind CSS", technology_type: "FRONTEND" },
  { name: "Sass", technology_type: "FRONTEND" },
  { name: "Next.js", technology_type: "FRONTEND" },
];
